...
CREATE TABLE t_chat_chat_d (
  ...
  CREATER_DATETIME DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT 'Chat Room Creation Datetime',
  CHAT_MANAGER_USER_ID VARCHAR(42) NOT NULL COMMENT 'Current Chat Room Manager User ID',
  CHAT_MANAGER_MODIFICATION_DATETIME DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT 'Datetime when the chat manager was last changed',
  CHAT_TYPE_CODE VARCHAR(4) NOT NULL COMMENT 'Chat Room Type Code',
  CHAT_INFO_MODIFICATION_DATETIME DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT 'Datetime when the chat room info was last modified',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Chat Detail';
...
CREATE TABLE `t_chat_chat_tag_l` (
  ...
  `REGISTRATION_DATETIME` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT 'Tag Registration Datetime',
...
CREATE TABLE `t_chat_message_d` (
  ...
  `USER_ID` VARCHAR(42) NOT NULL COMMENT 'User Identifier',
  `REGISTRATION_DATETIME` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT 'Message Registration Datetime',
