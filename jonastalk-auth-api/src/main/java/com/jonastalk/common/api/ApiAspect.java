...
import com.jonastalk.auth.v1.api.AllValidationRequestURI;
...
public class ApiAspect {
    ...
    @Pointcut("execution(* com.jonastalk.auth.v1.controller.*Controller.*(..))"
//    		+ " || execution(* com.jonastalk.*.*Controller.*(..))"
    ...
    @AfterThrowing(pointcut = "execution(* com.jonastalk.auth.v1.controller.*Controller.*(..))"
//    		+ " || execution(* com.jonastalk.*.*Controller.*(..))"
    		, throwing = "ex")
